...
import './Game.css'
import slika1 from '../assets/beta.jpg';
import slika2 from '../assets/beta.jpg';
...
export default function ComputerGame() {
    ...
    useEffect(() => {
        async function getAiMove() {
            ...
            try {
                ...
                await sleep(2000);  // Podesite vreme pauze pre sledećeg poteza (u milisekundama)
  ...
  </div> <div className={`player black ${color === 'black' && 'active'}`}>
        <h3>Player Black</h3>
        <div className="player-content">
          <div className="player-info">
