...
import slika2 from '../assets/beta2.png';
import slika3 from '../assets/woman1.png';
...
export default function GamKonacno({ mode, difficulty1, difficulty2, setModeSelection }) {
    ...
    function toBackendRepr() {
        ...
        console.log(gameData.difficulty + "odabaran HEURISTIKA")
        return gameData
    }
    ...
    // Definišite putanje slika za svaki scenarijo
const humanAiImages = {
    white: slika3,
    black: slika1,
  };
  ...
  <div className="layer-content player-contentt">
    <div className="player-infoo">
      ...
      <p className='yes'>Loptice:{whiteStonesCount}</p></div>
    ...
    <img 
      src={
        mode === 'human-ai'
          ...
          ? aiAiImages.white
          : 'mode === human-human'
            ? humanhumanImages.white
        : null

      }
      alt="White Stone Icon"
...
<div className={`player black ${color === 'black' && 'active'}`}>
  ...
  <div className="player-content">
   <div className='onako'>
    ...
    <img
      src={
        mode === 'human-ai'
          ...
          ? aiAiImages.black
          : mode === 'human-human'
            ? humanhumanImages.black
        : null

      }
      alt="Black Stone Icon"
    ...
    {/* <h3 className='h'>Player white</h3> */}
    <div className="player-info"><div className='novonesto'>
    ...
    {/* <h3 className='h'>Player black</h3> */}
